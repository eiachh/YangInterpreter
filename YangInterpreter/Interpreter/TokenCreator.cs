    ...
    internal static class TokenCreator
    {
        ...
        internal static void Init()
        {
            InterpreterSearchSchemeList = new List<SearchScheme>
            {
                ...
                new SearchScheme(new Regex(@"^\s*type\s*int64(?<bracket>.*{.*)*$",                                      RegexOptions.IgnoreCase),typeof(Int64TypeStatement)                ),
                new SearchScheme(new Regex(@"^\s*type\s*int32(?<bracket>.*{.*)*$",                                      RegexOptions.IgnoreCase),typeof(Int32TypeStatement)                ),
                new SearchScheme(new Regex(@"^\s*type\s*int16(?<bracket>.*{.*)*$",                                      RegexOptions.IgnoreCase),typeof(Int16TypeStatement)                 ),
                new SearchScheme(new Regex(@"^\s*type\s*int8(?<bracket>.*{.*)*$",                                       RegexOptions.IgnoreCase),typeof(Int8TypeStatement)               ),
                new SearchScheme(new Regex(@"^\s*type\s*uint64(?<bracket>.*{.*)*$",                                     RegexOptions.IgnoreCase),typeof(UInt64TypeStatement)               ),
                new SearchScheme(new Regex(@"^\s*type\s*uint32(?<bracket>.*{.*)*$",                                     RegexOptions.IgnoreCase),typeof(UInt32TypeStatement)                ),
                new SearchScheme(new Regex(@"^\s*type\s*uint16(?<bracket>.*{.*)*$",                                     RegexOptions.IgnoreCase),typeof(UInt16TypeStatement)               ),
                new SearchScheme(new Regex(@"^\s*type\s*uint8(?<bracket>.*{.*)*$",                                      RegexOptions.IgnoreCase), typeof(UInt8TypeStatement)             ),

                new SearchScheme(new Regex(@"^\s*type\s*decimal64(;\s*|(?<bracket>.*{.*)*)$",                           RegexOptions.IgnoreCase),typeof(Decimal64TypeStatement)              ),
